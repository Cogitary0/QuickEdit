...
console.add_command(
    ...
    function (args, kwargs)
        ...
        if string.lower(filled) == 'true' or string.lower(filled) == 'false' then
            filled = filled == 'true'
        end
        ...
        if #container:get().pos1 ~= 0 and #container:get().pos2 ~= 0 then
            ...
            if command == "del" then
                ...
                trash = {"del"}
            elseif command == "terrain" then
                mainBuild.terrain(container:get().pos1, container:get().pos2, container:get().bag, filled)
            else
