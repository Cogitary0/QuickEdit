...
function editorSession.fill(pos1, pos2, use) mainBuild.fill(pos1, pos2, use) end

function editorSession.linespace(pos1, pos2, use) mainBuild.linespace(pos1, pos2, use) end

function editorSession.cuboid(pos1, pos2, use) mainBuild.cuboid(pos1, pos2, use) end
...
function editorSession.cylinder(pos1, pos2, use) mainBuild.cylinder(pos1, pos2, use) end
